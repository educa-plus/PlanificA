...
@onready var up_hour = $TimeModifierMargin/TimeModifier/UpButton/UpHour
@onready var up_minute = $TimeModifierMargin/TimeModifier/UpButton/UpMinute
@onready var down_hour = $TimeModifierMargin/TimeModifier/DownButton/DownHour
@onready var down_minute = $TimeModifierMargin/TimeModifier/DownButton/DownMinute

@onready var hour_label = %HourEdit
@onready var minute_label = %HourEdit2

@onready var back = $TimeModifierMargin/Control/Back
@onready var next = $TimeModifierMargin/TimeModifier/Steps/Next

@onready var up_hour_repeat_timer = $TimeModifierMargin/TimeModifier/UpButton/UpHourRepeatTimer
@onready var up_minute_repeat_timer = $TimeModifierMargin/TimeModifier/UpButton/UpMinuteRepeatTimer
@onready var down_hour_repeat_timer = $TimeModifierMargin/TimeModifier/DownButton/DownHourRepeatTimer
@onready var down_minute_repeat_timer = $TimeModifierMargin/TimeModifier/DownButton/DownMinuteRepeatTimer
